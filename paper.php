...
if (isset($_POST['submit'])) {
    if ($name != "" and $email != "" and $designation != "" and $phone != "" and $instiname != "" and $author != "" and $description != "" and $field != "" and $imageFileType!="") {
            ...
            $folder       = "http://reflux.in/Paper/";
            $insert       = "Insert into paper_submission(Name,Email,Designation,field,Phone,Institute_name,Author,Description,Abstract,names) values('" . $name . "','" . $email . "','" . $designation . "','" . $field . "','" . $phone . "','" . $instiname . "','" . $author . "','" . $description . "','" . $folder.$upload_image. "','" . $_FILES["fileToUpload"]["name"] . "')";
        ...
        echo "<script type='text/javascript'>alert('$message'); window.location = 'http://reflux.in/Paper.html';</script>";
    }
