...
if (isset($_POST['submit'])) {
    if ($name1 != "" and $email != "" and $designation != "" and $phone != "" and $instiname != ""  and $imageFileType!="") {
            ...
            $folder       = "http://reflux.in/case-study/";
            $insert       = "Insert into case_study(Name_1,Name_2,Email,Designation,Phone,Institute_name,Presentation_link,names) values('" . $name1 . "','" . $name2 . "','" . $email . "','" . $designation . "','" . $phone . "','" . $instiname . "','" . $folder.$upload_image. "','" . $_FILES["fileToUpload"]["name"] . "')";
        ...
        echo "<script type='text/javascript'>alert('$message'); window.location = 'http://reflux.in/case-study.html';</script>";
    }
